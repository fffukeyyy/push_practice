...
function getSuggestionForFieldAttribute(block, currentLine, lines, wordsBeforePosition, document, onError) {
    ...
    const modelOrTypeOrEnum = (0, ast_1.getDatamodelBlock)(fieldType, lines);
    suggestions = filterSuggestionsForLine(suggestions, currentLine, fieldType, modelOrTypeOrEnum === null || modelOrTypeOrEnum === void 0 ? void 0 : modelOrTypeOrEnum.type);
